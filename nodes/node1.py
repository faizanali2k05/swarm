"""Node 1 simulation: trains on sklearn digits, sends flattened weights + data hash to backend."""
import hashlib
import json
import requests
import os
...
# make parent folder importable so `backend` package can be imported when running from nodes/
